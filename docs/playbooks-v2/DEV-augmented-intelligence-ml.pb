...
**Related Playbooks**:
- Playbook 1: Cost Optimization (caching + batch patterns)
- Playbook 2: Extended Thinking (ML decision reasoning)
- Playbook 4: Knowledge Engineering (experiment tracking as KG)
- Playbook 5: Enhanced Coding (code generation patterns)
