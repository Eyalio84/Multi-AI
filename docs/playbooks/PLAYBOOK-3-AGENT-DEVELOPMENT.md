...
**Related Playbooks:** [PB 1](PLAYBOOK-1-COST-OPTIMIZATION.md) (costs), [PB 2](PLAYBOOK-2-EXTENDED-THINKING.md) (thinking), [PB 10](PLAYBOOK-10-MCP-SERVER-DEVELOPMENT.md) (MCP for agents)
...
3. [Why Build Agents with Claude?](#why-build-agents-with-claude)
4. [Core Agent Patterns](#core-agent-patterns)
...
- **[Playbook 1: Cost Optimization](PLAYBOOK-1-COST-OPTIMIZATION.md)** - Agent cost optimization strategies
- **[Playbook 2: Extended Thinking](PLAYBOOK-2-EXTENDED-THINKING.md)** - Transparent agent reasoning
- **[Playbook 10: MCP Server Development](PLAYBOOK-10-MCP-SERVER-DEVELOPMENT.md)** - Build tools for agents
