...
**Related Playbooks:** [PB 1](PLAYBOOK-1-COST-OPTIMIZATION.md) (costs), [PB 2](PLAYBOOK-2-EXTENDED-THINKING.md) (reasoning), [PB 3](PLAYBOOK-3-AGENT-DEVELOPMENT.md) (agents), [PB 4](PLAYBOOK-4-KNOWLEDGE-ENGINEERING.md) (KG)
...
**See Also (Playbooks)**:
- **[Playbook 1: Cost Optimization](PLAYBOOK-1-COST-OPTIMIZATION.md)** - Caching, batch processing
- **[Playbook 2: Extended Thinking](PLAYBOOK-2-EXTENDED-THINKING.md)** - Complex reasoning for code
- **[Playbook 3: Agent Development](PLAYBOOK-3-AGENT-DEVELOPMENT.md)** - Coding agents
- **[Playbook 4: Knowledge Engineering](PLAYBOOK-4-KNOWLEDGE-ENGINEERING.md)** - Codebase as KG
