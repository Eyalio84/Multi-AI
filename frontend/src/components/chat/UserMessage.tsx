...
const UserMessage: React.FC<{ message: Message }> = ({ message }) => (
  <div className="t-card p-3 rounded-2xl max-w-[85vw] lg:max-w-2xl xl:max-w-4xl break-words rounded-br-none overflow-hidden" style={{ background: 'var(--t-primary)', color: 'var(--t-text)', overflowWrap: 'anywhere' }}>
