...
const links = [
  ...
  { to: '/experts', label: 'Experts', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
  ...
  { to: '/vox', label: 'VOX', icon: 'M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z' },
  { to: '/games', label: 'Games', icon: 'M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  { to: '/tools', label: 'Tools', icon: 'M11.42 15.17l-5.384 3.18.96-5.593L2.7 8.574l5.61-.814L11.42 2.5l2.507 5.26 5.61.814-4.296 4.183.96 5.593-5.384-3.18z' },
